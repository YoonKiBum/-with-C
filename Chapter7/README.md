...
전체의 코드는 각각 다음과 같다. <br>
Deque.h: ([C Language 코드](/Chapter7/Example/Deque.h)) <br>
Deque.c: ([C Language 코드](/Chapter7/Example/Deque.c)) <br>
DequeMain.c: ([C Language 코드](/Chapter7/Example/DequeMain.c)) <br>
