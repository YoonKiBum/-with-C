...
<img src = "/res/Chapter8/tree.JPG"> <br>
구성요소는 다음과 같다. <br>
### 노드 Node
...
### 단말 노드 Terminal Node
아래로 다른 노드가 없는 경우 위의 그림에서는 B, C, D, E
